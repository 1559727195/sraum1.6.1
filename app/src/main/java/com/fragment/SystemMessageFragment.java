...
//        ToastUtil.showToast(getActivity(),"SystemMessageFragment");
    }
...
//                View v = parent.getChildAt(position - xListView_scan.getFirstVisiblePosition());
    ...
    public static SystemMessageFragment newInstance(OnDeviceMessageFragListener onDeviceMessageFragListener) {
