...
//    public static List<RemoteControl> list_remotecontrol = new ArrayList<>();//存储各种遥控器编码列表
//    public static List<Map> list_remote_others = new ArrayList<>();//存储各种遥控器编码列表对应的rid,mac参数
    ...
    private void addFragment() {
        macFragment = MacFragment.newInstance();
