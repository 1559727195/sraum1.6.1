...
import com.ipcamera.demo.SCameraSetPushVideoTiming;
...
public class BuFangBaoJingPlanActivity extends Basecactivity implements BridgeService.PushTimingInterface, BridgeService.CallBack_AlarmParamsInterface {
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 0:// 设置失败
                    Toast.makeText(BuFangBaoJingPlanActivity.this, R.string.alerm_set_failed, Toast.LENGTH_LONG)
                            .show();
                    break;
                case 1:// 设置成功
