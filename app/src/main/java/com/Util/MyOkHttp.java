...
public class MyOkHttp {
    ...
    public static void postMapObjectnest(String url, Map<String, Object> mapData, MycallbackNest back) {
        ...
        OkHttpUtils
                .postString()
                .url(url)
                .content(JSON.toJSONString(mapData))
                .build()
                .execute(back);
    }
    ...
    public static void postMapObject(String url, Map<String, Object> mapData, Mycallback back) {
       Log.e("zhu", JSON.toJSONString(mapData) + "postMapString: ");
        OkHttpUtils
                .postString()
                .url(url)
                .content(JSON.toJSONString(mapData))
     ...
     * @param back    请求返回
     */
    public static void postMapObject_WIFI(String url, Map mapData, Mycallback back) {
        Log.e("zhu", JSON.toJSONString(mapData) + "postMapString: ");
        OkHttpUtils
                .postString()
                .url(url)
     ...
     * @param back    请求返回
     */
    public static void postMapObject_WIFI_CONTENT(String url, String mapData, Mycallback back) {
        Log.e("zhu", JSON.toJSONString(mapData) + "postMapString: ");
        OkHttpUtils
                .postString()
                .url(url)
