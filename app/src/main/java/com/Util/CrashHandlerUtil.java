...
public class CrashHandlerUtil implements Thread.UncaughtExceptionHandler {
    ...
    public void init_crash(Context context) {
        mContext = context;
...
//                StringUtils.showMsgAsCenter(mContext,getCrashTip());
                ToastUtil.showToast(mContext,getCrashTip());
                Looper.loop();
            }
        }.start();
        //收集设备参数信息
...
//                Logger.e(field.getName() + " : " + field.get(null));
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        sb.append(result);
        Logger.e("robin debug",sb.toString());
...
//        SharedPreferencesUtil.saveData(mContext,"crashInfo",crashInfo);
        LogcatHelper.getInstance(mContext,crashInfo).start();
        return null;
    }
}
