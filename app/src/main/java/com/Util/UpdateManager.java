...
import com.Util.breakpoint.DownloadProgressListener;
import com.Util.breakpoint.DownloadThread;
import com.Util.breakpoint.FileDownloadered;
 ...
 */
//用于自动版本更新和安装
public class UpdateManager implements MainfragmentActivity.UpdateApkListener {
    /* 下载中 */
