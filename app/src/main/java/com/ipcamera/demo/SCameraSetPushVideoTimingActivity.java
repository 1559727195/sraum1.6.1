...
//			setResult(2015, its);
    ...
    public void showToast(String t) {
        Toast.makeText(SCameraSetPushVideoTimingActivity.this, t, 1000).show();
    }
...
//			finish();
    ...
    private void showDefaultSetDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(SCameraSetPushVideoTimingActivity.this);
